...
public class StudentDbUtil {
	...
	public StudentDbUtil(DbManager thedbManager) {
...
;				String email = myRs.getString("email");
	...
	public static Student getStudentId(String theStudentId) throws Exception {
	...
	public static List<Student> searchStudents(String theSearchName) throws Exception {
		...
		try {
			...
			if(theSearchName!=null && (theSearchName.trim().length() > 0) ) {
				...
				// create sql to search student by name
				...
				// create sql to get all the students
